The purpose of this is to define a standardised set of words for a set of common moves / pattens to make it easier to talk about and write down / notate the shape of a [maze](https://hub.retrocyclesleague.com/mazing).
